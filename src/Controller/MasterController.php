...
//                    ]), true)
            ...
            'slidingLayerManager' => [
                'listings' => [
                    'html' => highlight_string($this->renderView("hawk/widgets/sliding-layer-manager/hawk-sliding-layer-manager.html", [
                    ]), true),
                    'js' => highlight_string($this->renderView("hawk/widgets/sliding-layer-manager/sliding-layer-manager.js", [
                    ]), true)
                ]
            ],
            ...
            'formSender' => [
                'staticFormSender' => [
                    'listings' => [
                        ...
                        'js' => highlight_string($this->renderView("hawk/widgets/form-sender/static-form-sender.js", [
                        ]), true)
                    ]
                ]
            ],
            ...
            'ajaxRequestManager' => [
                'listings' => [
                    'js' => highlight_string($this->renderView("hawk/widgets/ajax-request-manager/ajax-request-manager.js", [
                    ]), true)
                ]
            ]
        ]);
